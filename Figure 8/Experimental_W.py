...
'''
Modified Warner, theoretical analysis
'''
...
for i in range(num_of_epsilon):
    ...
    var_MW_Theory_Analysis[i] = pi_A*(1-pi_A)/N + p_real_Warner[i] * (1 - p_real_Warner[i]) / ((2 * p_real_Warner[i] - 1) ** 2) / N
...
with open('Experimental_W.txt', 'w') as file:
